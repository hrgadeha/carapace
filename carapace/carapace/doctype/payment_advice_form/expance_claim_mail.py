...
def sendMail(doc,method):
	...
	if doc.advice_type != 'General PA':
		to_user = []
		cc_user = []
		content = "<h4>Hello,</h4><h2>Kind Attention: Mr. Souvik Das / Mr. Vivek Sharma,</h2><p>Please release the payment against Payment Advice.</p><br><h4><center><b>Payment Advice</b></center></h4><table class='table table-bordered'><table class='table table-bordered'><tr><td>Party Type : "+str(doc.party_type)+"</td><td>Payment Advice : "+str(doc.name)+"</td></tr><tr><td>Party : "+str(doc.party)+"</td><td>Advice Date: "+str(doc.date)+"</td></tr><tr><td>Reference Type : "+str(doc.reference_type)+"</td><td>Status : "+str(doc.workflow_state)+"</td></tr><tr><td>Reference No : "+str(doc.reference_no)+"</td><td>Remarks : "+str(doc.remarks)+"</td></tr><tr><td>Project Site : "+str(doc.project_site)+"</td><td></td></tr><tr><td>Payment Type : "+str(doc.payment_type)+"</td><td></td></tr></table>"
